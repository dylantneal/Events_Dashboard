...
echo "1. Monthly updates only (4-month rolling window + calendar)"
...
case $REPLY in
    ...
    8)
        ...
        echo ""
        echo "For monthly updates (4-month rolling window + calendar):"
...
echo "====================================="
echo ""
echo "✅ 4-month rolling window functionality is ready"
